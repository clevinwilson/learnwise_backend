...
const { createCommunity, getAllCommunity, joinCommunity, getJoinedCommunit, getCommunityDetails, createCommunityPost,getCommunityFeeds } = require('../controller/communityController');
